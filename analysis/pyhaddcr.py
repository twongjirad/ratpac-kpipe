...
ana_merge = "crana_merged_wdarknoise_0_1999.root"
cry_add = ""
ana_add = ""
...
for p in xrange(0,ntemp_files):
    ...
    for n in xrange(0,100):
        fnum = 100*p + n
        g = "/net/nudsk0001/d00/scratch/taritree/cry_gen/0/cry_events_%d.root"%(n)
        f = "/net/nudsk0001/d00/scratch/taritree/crkpipe_ana_wdarknoise/output_cr_analysis_%04d.root"%(fnum)
...
os.system("rm crana_merged_wdarknoise_0_1999.root")
