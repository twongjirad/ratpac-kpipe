...
def gen_macro( outfile, jobid, kdar_source, kpipe_gdml, nevents_per_job ):
...
"""
    ...
    gen_str = "/generator/add external external:uniform:\"./simple_gen_kdar_event %s %d %s %d |\"" % (kdar_source, nevents_per_job, kpipe_gdml, offset)
...
if __name__=="__main__":
    if len( sys.argv)==1:
        ...
        gen_macro( sys.argv[1], int(sys.argv[2]), sys.argv[3], sys.argv[4], 1000 )
